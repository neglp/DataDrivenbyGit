...
String inputpath ="E:\\Testingselenium\\DDTFrameWork\\FileInput\\LoginData.xlsx";
String outputpath ="E:\\Testingselenium\\DDTFrameWork\\FileOutput\\DataDrivenResults.xlsx";
@Test
public void startTest() throws Throwable
{
	...
	for(int i=1;i<=rc;i++)
	{
		...
		else
		{
			...
			FileHandler.copy(screen, new File("./Screenshot/Iteration/"+i+"Loginpage.png"));
